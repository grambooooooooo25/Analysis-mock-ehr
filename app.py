...
WEBSITE_UPLOAD_URL = "https://mock-ehr-1.onrender.com/upload-session"
...
def analyze_drive():
    ...
    website_payload = {
        ...
        "warning": "YES" if result["risk_score"] > 25 else "NO",
        "create_alert": True if result["risk_score"] > 25 else False,
        "alert_message": result["warning_text"] if result["risk_score"] > 25 else "",
